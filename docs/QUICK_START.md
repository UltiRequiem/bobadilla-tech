...
- ✅ **5 Industry Pages** - Healthcare, Education, Finance, Transportation,
  AI/ML
...
Currently using Geist Sans. To change, edit
...
To customize the WebGL shader, edit
[src/components/shaders/ShaderBackground.tsx](src/components/shaders/ShaderBackground.tsx):
...
All healthcare, education, finance, transportation, and AI/ML services have
individual pages.
...
If you need help customizing or have questions about the implementation, refer
to:

...
const showcases = [
	{
		...
		slug: "healthcare",
		description:
			"Extensive experience building HIPAA-compliant telemedicine platforms, patient management systems, and health data analytics solutions",
		image:
	...
	},
	{
		...
		slug: "finance",
		description:
			"Proven expertise in secure payment processing, trading platforms, and AI-powered financial analytics systems",
		image:
	...
	},
	{
		...
		slug: "education",
		description:
			"Deep experience creating interactive learning platforms, student management systems, and adaptive learning solutions",
		image:
	...
	},
	{
		...
		description:
			"Specialized knowledge in real-time tracking systems, warehouse management, and supply chain optimization platforms",
		image:
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-gray-400 max-w-2xl mx-auto">
						Proven expertise delivering specialized solutions across diverse
						sectors
					</p>
				</motion.div>
				...
				>
					{showcases.map((project) => (
						<Link key={project.id} href={`/services/all/${project.slug}`}>
							<motion.div

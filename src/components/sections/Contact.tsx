          ...
          >
            ...
            <div className="p-8 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-2xl">
              ...
              <p className="text-gray-300 mb-6">
                Schedule a 15-minute consultation to discuss your project and get a custom quote.
              </p>
              <a
                href="#book-call"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 transform hover:scale-105"
              >
                Schedule Now
              </a>
            </div>
            ...
            <div className="p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/30 backdrop-blur-sm border border-white/10 rounded-2xl space-y-6">
              ...
              <div className="flex items-center space-x-4 text-gray-300 hover:text-white transition-colors duration-300">
                <Mail className="w-6 h-6 text-cyan-400" />
                <span>contact@bobatech.dev</span>
              </div>
              ...
              <div className="pt-4 border-t border-white/10">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://linkedin.com/company/bobatech"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/bobatech"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-white/5 rounded-lg hover:bg-cyan-500/20 text-gray-400 hover:text-cyan-400 transition-all duration-300"
                  >
            ...
            <div className="p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl">
              <h4 className="text-lg font-semibold text-white mb-2">Fast Response Time</h4>

...
const tools = [
  {
    ...
    description: 'Extract the exact creation date and time from any Reddit post. Perfect for research, verification, and accurate citations.',
    icon: Calendar,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">
              Free <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Tools</span>
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Powerful online tools built for developers, researchers, and content creators.
          ...
          <div className="mt-16 text-center">
            <div className="inline-block p-8 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl">
              <h3 className="text-2xl font-bold text-white mb-2">More Tools Coming Soon</h3>
          ...
          <div className="mt-16 bg-gradient-to-br from-slate-900/50 to-slate-800/30 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Why Use Our Tools?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">100% Free</h3>
                <p className="text-gray-400 text-sm">
                  All our tools are completely free to use. No hidden fees, no subscriptions.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Privacy-Focused</h3>
                <p className="text-gray-400 text-sm">
                  We don&apos;t store your data. Everything happens in your browser.
                </p>
              </div>
              <div>

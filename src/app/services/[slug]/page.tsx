...
import { CheckCircle, ArrowRight, Zap, Shield, Clock, TrendingUp } from 'lucide-react';
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/30 backdrop-blur-sm border border-white/10 rounded-2xl">
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  Our {service.title.toLowerCase()} service combines cutting-edge technology with deep engineering expertise
                  to deliver solutions that drive business results. We work closely with you to understand your unique
                  requirements and create custom solutions that scale with your business.
                </p>
                <p className="text-gray-300 leading-relaxed">
                  Whether you&apos;re a startup looking to launch your MVP quickly or an enterprise seeking robust,
                  scalable solutions, our team has the experience and expertise to bring your vision to life.
                </p>
              </section>
            ...
            <div className="space-y-6">
              ...
              <div className="p-8 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-2xl sticky top-24">
                ...
                <p className="text-gray-300 mb-6">
                  Book a free consultation to discuss your project and receive a custom quote.
                </p>
                ...
                <div className="mt-6 pt-6 border-t border-white/10">
                  ...
                  <p className="text-sm text-gray-400 mt-1">for static websites</p>
                </div>
              </div>
            </div>
          </div>

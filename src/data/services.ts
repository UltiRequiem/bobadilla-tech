...
export const allServices: Service[] = [
  ...
  },
  {
    ...
    description: 'Powerful content management systems tailored to your business needs.',
    category: 'development'
  },
  {
    id: 'mvp-dev',
    ...
    description: 'Launch your startup in days or weeks, not months. Rapid MVP development to validate your idea.',
    category: 'development'
  },
  {
    id: 'web-app-dev',
    ...
    description: 'Full-featured web applications with robust backend systems and intuitive interfaces.',
    category: 'development'
  },
  {
    id: 'mobile-app-dev',
  ...
  },
  {
    ...
    description: 'Enterprise-grade backend systems built by senior engineering talent.',
    category: 'development'
  },
  {
    id: 'frontend-dev',
  ...
  },
  {
    ...
    description: 'Custom web portals for internal tools, customer dashboards, and more.',
    category: 'development'
  }
];
...
export const industryServices: IndustryService[] = [
  {
    ...
    industry: 'Healthcare',
    slug: 'healthcare',
    description: 'HIPAA-compliant healthcare solutions with enterprise security and scalability.',
    services: [
      {
        id: 'healthcare-software',
        title: 'Healthcare Software Development',
        slug: 'healthcare-software-development',
        description: 'Custom healthcare software solutions built with compliance and security in mind.'
      },
      {
        id: 'healthcare-it',
        title: 'Healthcare IT Consulting',
        slug: 'healthcare-it-consulting',
        description: 'Expert guidance on healthcare technology strategy and implementation.'
      },
      {
        id: 'healthcare-app',
        title: 'Healthcare App Development',
        slug: 'healthcare-app-development',
        description: 'Mobile and web applications for healthcare providers and patients.'
      },
      {
        id: 'healthcare-uiux',
      ...
      },
      {
        ...
        description: 'Patient-facing applications for health tracking and telemedicine.'
      },
      {
        id: 'healthcare-testing',
        title: 'Healthcare Software Testing',
        slug: 'healthcare-software-testing',
        description: 'Comprehensive testing to ensure reliability and compliance.'
      },
      {
        id: 'telemedicine-app',
      ...
      },
      {
        ...
        description: 'Professional websites for healthcare providers and organizations.'
      }
    ]
  },
  {
    ...
    industry: 'Education',
    slug: 'education',
    description: 'Transform learning experiences with innovative educational technology solutions.',
    services: [
      {
        id: 'education-software',
        title: 'Education Software Development',
        slug: 'education-software-development',
        description: 'Custom educational software for institutions and EdTech startups.'
      },
      {
        id: 'education-app',
      ...
      },
      {
        ...
        description: 'Learning Management Systems tailored to your educational needs.'
      },
      {
        id: 'elearning-app',
      ...
      },
      {
        ...
        description: 'Comprehensive e-learning solutions with advanced features.'
      },
      {
        id: 'education-portals',
        title: 'Education Portals Development',
        slug: 'education-portals-development',
        description: 'Student and teacher portals for educational institutions.'
      },
      {
  ...
  },
  {
    ...
    industry: 'Finance',
    slug: 'finance',
    description: 'Secure, compliant financial technology solutions built with enterprise-grade security.',
    services: [
      {
      ...
      },
      {
        ...
        description: 'Professional websites for financial institutions and services.'
      },
      {
      ...
      },
      {
        ...
        description: 'Full-featured banking applications with advanced security.'
      },
      {
        id: 'payment-app',
  ...
  },
  {
    ...
    description: 'Optimize operations with intelligent transportation and logistics solutions.',
    services: [
      {
        id: 'transportation-software',
        title: 'Transportation Software Development',
        slug: 'transportation-software-development',
        description: 'Custom software for transportation companies and logistics providers.'
      },
      {
        id: 'logistics-app',
        title: 'Logistics App Development',
        slug: 'logistics-app-development',
        description: 'Mobile and web apps for logistics management and tracking.'
      },
      {
        id: 'logistics-web-design',
        title: 'Logistics Web Design',
        slug: 'logistics-web-design',
        description: 'Professional websites for logistics and transportation companies.'
      },
      {
        id: 'transportation-management',
        title: 'Transportation Management Software',
        slug: 'transportation-management-software',
        description: 'Comprehensive TMS solutions for fleet and route optimization.'
      },
      {
  ...
  },
  {
    ...
    description: 'Cutting-edge AI solutions powered by deep engineering expertise.',
    services: [
      {
        id: 'ai-consulting',
